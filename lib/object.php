...
class Object
{
	...
	*/
	function changeKey($key,$newKey,&$arr,$rewrite=true){
	    if(!array_key_exists($newKey,$arr) || $rewrite){
	        $arr[$newKey]=$arr[$key];
	        unset($arr[$key]);
	        return true;
	    }
	...
	* @return mixed
	*/
	public static function onHandler($handlers, $name, &$arg1=null, &$arg2=null, &$arg3=null, &$arg4=null, &$arg5=null, &$arg6=null, ...$arg7)
	{
	...
	public static function call($func, $args=array())
	{
